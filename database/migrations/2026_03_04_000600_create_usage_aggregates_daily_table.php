...
return new class extends Migration
{
    ...
    {
        Schema::create('usage_aggregates_daily', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['project_id', 'api_key_id', 'bucket_date', 'route', 'method'], 'usage_daily_unique');
            $table->index(['project_id', 'bucket_date']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('usage_aggregates_daily');
    }
};
